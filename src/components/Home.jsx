  ...
  return (
    <>
      <section className="w-full h-screen  mb-2">
          ...
          <div className=" flex">
            ...
            {Carpetas.map((carpeta) => (
              <div
                ...
                key={carpeta.id}
                className=" flex justify-start items-center cursor-pointer gap-1 hover:scale-105 px-2 pl-0 py-1 rounded-md duration-300 ease-in-out"
              >
                <SVGFolder />
        ...
        <section className="w-full py-5 flex  flex-wrap mx-auto max-w-screen-xl  sm:px-6  justify-between   ">
          <div className="w-[30%] flex justify-start items-center  flex-col gap-6 ">
